    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function (e) {
            ...
            var g = this._canAdjustMonth(e, -1, d, p)
                ? '<a class="ui-datepicker-prev btn btn-link" data-handler="prev" data-event="click"' + ' title="' + m + '">' + (n ? '<i class="icon-circle-arrow-right"></i>' : '<i class="icon-circle-arrow-left"></i>') + "</a>"
                : i
                ? ""
                : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="' + m + '">' + (n ? '<i class="icon-circle-arrow-right"></i>' : '<i class="icon-circle-arrow-left"></i>') + "</a>";
            ...
            var b = this._canAdjustMonth(e, +1, d, p)
                ? '<a class="ui-datepicker-next btn btn-link" data-handler="next" data-event="click"' + ' title="' + y + '">' + (n ? '<i class="icon-circle-arrow-left"></i>' : '<i class="icon-circle-arrow-right"></i>') + "</a>"
                : i
                ? ""
                : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="' + y + '">' + (n ? '<i class="icon-circle-arrow-left"></i>' : '<i class="icon-circle-arrow-right"></i>') + "</a>";
            ...
            var x = r
                ? '<div class="ui-datepicker-buttonpane ui-helper-clearfix">' +
                  (n ? S : "") +
                  (this._isInRange(e, E) ? '<button type="button" class="ui-datepicker-current btn" data-handler="today" data-event="click"' + ">" + w + "</button>" : "") +
                  (n ? "" : S) +
                  "</div>"
                : "";
